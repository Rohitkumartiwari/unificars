import img1 from "../../public//Rectangle 763.png";
import img2 from "../../public/Rectangle 758.png"
    ...
    <div className="container gray py-5">
      ...
      <div className="flex flex-wrap justify-center mt-4">
        <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-2 mb-4 text-start ">
          <div className="bg-cover bg-center  relative rounded-2xl text-white flex flex-col justify-end bg-white ">
            ...
            <div className="px-3 py-4">
              ...
              <h4
                className="text-black text-start  text-1xl font-medium"
                style={{ fontFamily: "Castoro" }}
              >
              ...
              <h6 className="text-xs text-black">View More </h6>
              <FiArrowRightCircle color="black"/>
              </div>
            </div>
          </div>
        </div>
        <div className="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 px-2 mb-4 text-start text-white ">
          ...
          >
            <div className="px-3 py-4 ">
              <h6 className="text-xs my-2  ">BY BOLDTHEMES / JANUARY 10,2018</h6>
              <h4
              ...
              <div className="flex gap-2">
              <h6 className="text-xs text-white">View More </h6>
...
export default essentialsReads;
