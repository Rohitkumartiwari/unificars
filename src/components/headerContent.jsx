    ...
    >
      <div className="container mx-auto text-center">
        ...
        <div className="text-start hidden md:flex">
          <button className="border border-solid border-orange-500 bg-orange-500 rounded-lg p-2 md:px-4  my-3">Booking Session Now</button>
        </div>
        <div className=" hidden md:flex border border-solid border-gray-200 bg-gray-300 rounded-lg overflow-hidden p-4  flex-col md:flex-row md:gap-1 justify-around opacity-60">
        <input
                  type="text"
